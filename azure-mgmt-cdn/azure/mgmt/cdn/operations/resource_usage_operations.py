...
class ResourceUsageOperations(object):
    ...
    :ivar api_version: Version of the API to be used with the client request. Current version is 2017-04-02. Constant value: "2025-10-14".
    """
