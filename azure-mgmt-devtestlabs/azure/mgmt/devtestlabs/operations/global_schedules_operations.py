...
class GlobalSchedulesOperations(object):
    ...
    def list_by_resource_group(
        ...
        return deserialized
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules/{name}'}
    ...
    def create_or_update(
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules/{name}'}
    ...
    def update(
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules/{name}'}
    ...
    execute.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules/{name}/execute'}


    def _retarget_initial(
            self, resource_group_name, name, current_resource_id=None, target_resource_id=None, custom_headers=None, raw=False, **operation_config):
        retarget_schedule_properties = models.RetargetScheduleProperties(current_resource_id=current_resource_id, target_resource_id=target_resource_id)

        # Construct URL
        url = self.retarget.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'name': self._serialize.url("name", name, 'str')
        ...
        # Construct body
        body_content = self._serialize.body(retarget_schedule_properties, 'RetargetScheduleProperties')
    ...
    def retarget(
            self, resource_group_name, name, current_resource_id=None, target_resource_id=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    retarget.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/schedules/{name}/retarget'}
