...
class ArtifactOperations(object):
    ...
    def list(
            self, resource_group_name, lab_name, artifact_source_name, filter=None, top=None, order_by=None, custom_headers=None, raw=False, **operation_config):
        """List artifacts.
    ...
    def get_resource(
            self, resource_group_name, lab_name, artifact_source_name, name, custom_headers=None, raw=False, **operation_config):
        """Get artifact.
        ...
        return deserialized
    get_resource.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/artifactsources/{artifactSourceName}/artifacts/{name}'}
