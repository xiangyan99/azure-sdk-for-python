...
class GalleryImage(Model):
    ...
    def __init__(self, *, author: str=None, created_date=None, description: str=None, image_reference=None, icon: str=None, enabled: bool=None, id: str=None, name: str=None, type: str=None, location: str=None, tags=None, **kwargs) -> None:
