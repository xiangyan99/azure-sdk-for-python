...
class ArtifactSource(Model):
    ...
    def __init__(self, *, display_name: str=None, uri: str=None, source_type=None, folder_path: str=None, branch_ref: str=None, security_token: str=None, status=None, provisioning_state: str=None, id: str=None, name: str=None, type: str=None, location: str=None, tags=None, **kwargs) -> None:
