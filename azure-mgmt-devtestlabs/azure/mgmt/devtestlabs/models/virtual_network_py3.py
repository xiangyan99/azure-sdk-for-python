...
class VirtualNetwork(Model):
    ...
    def __init__(self, *, allowed_subnets=None, description: str=None, external_provider_resource_id: str=None, subnet_overrides=None, provisioning_state: str=None, id: str=None, name: str=None, type: str=None, location: str=None, tags=None, **kwargs) -> None:
