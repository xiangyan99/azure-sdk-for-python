...
class CostPerDayProperties(Model):
    ...
    :param cost: The cost of the cost item.
    :type cost: float
    :param cost_type: The type of the cost. Possible values include:
     'Unavailable', 'Reported', 'Projected'
    :type cost_type: str or ~azure.mgmt.devtestlabs.models.CostPropertyType
    """
    ...
    def __init__(self, **kwargs):
        super(CostPerDayProperties, self).__init__(**kwargs)
