...
class AzureConfigurationClient(object):
    ...
    def add_key_value(
        ...
        return self._client.create_or_update_key_value(key_value=key_value, key=key, label=key_value.label, custom_headers=custom_headers)
    ...
    def update_key_value(
        ...
        return self._client.create_or_update_key_value(key_value=current_key_value, key=key, label=label, custom_headers=custom_headers)
    ...
    def delete_key_value(
        ...
        if etag is not None:
            ...
            if custom_headers is None:
                ...
                custom_headers.update(if_match)
        return self._client.delete_key_value(key=key, label=label, custom_headers=custom_headers)
