...
class ApplicationGateway(Resource):
    ...
    :param firewall_policy: Web application firewall policy.
    :type firewall_policy:
     ~azure.mgmt.network.v2018_12_01.models.WebApplicationFirewallPolicy1
    ...
    _attribute_map = {
        ...
        'firewall_policy': {'key': 'properties.firewallPolicy', 'type': 'WebApplicationFirewallPolicy1'},
