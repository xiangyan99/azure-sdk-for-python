...
class CustomRule(Model):
    ...
    :type priority: int
    :ivar rule_type: Required. Describes type of rule. Default value:
     "MatchRule" .
    ...
    _validation = {
        ...
        'rule_type': {'required': True, 'constant': True},
    ...
    def __init__(self, *, priority: int, match_conditions, action, name: str=None, **kwargs) -> None:
