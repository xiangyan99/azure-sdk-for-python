...
class StreamingPoliciesOperations(object):
    ...
    def list(
        ...
        :return: An iterator like instance of StreamingPolicy
        :rtype:
         ~azure.mgmt.media.models.StreamingPolicyPaged[~azure.mgmt.media.models.StreamingPolicy]
        :raises:
        ...
        deserialized = models.StreamingPolicyPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.StreamingPolicyPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/mediaServices/{accountName}/streamingPolicies'}

    def get(
            self, resource_group_name, account_name, streaming_policy_name, custom_headers=None, raw=False, **operation_config):
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('StreamingPolicy', response)
    ...
    def create(
            self, resource_group_name, account_name, streaming_policy_name, parameters, custom_headers=None, raw=False, **operation_config):
