...
class MarketplacesOperations(object):
    ...
    :ivar api_version: Version of the API to be used with the client request. The current version is 2018-11-01. Constant value: "2018-11-01".
    """
    ...
    def list_by_billing_account(
        ...
        return deserialized
    list_by_billing_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/marketplaces'}
    ...
    def list_for_billing_period_by_billing_account(
        ...
        return deserialized
    list_for_billing_period_by_billing_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces'}
    ...
    def list_by_department(
        ...
        return deserialized
    list_by_department.metadata = {'url': '/providers/Microsoft.Billing/departments/{departmentId}/providers/Microsoft.Consumption/marketplaces'}
    ...
    def list_by_management_group(
            self, management_group_id, filter=None, top=None, skiptoken=None, custom_headers=None, raw=False, **operation_config):
        """Lists the marketplace records for all subscriptions belonging to a
        management group scope by current billing period. Marketplaces are
        ...
        return deserialized
    list_by_management_group.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Consumption/marketplaces'}

    def list_for_billing_period_by_management_group(
            self, management_group_id, billing_period_name, filter=None, top=None, skiptoken=None, custom_headers=None, raw=False, **operation_config):
        """Lists the marketplace records for all subscriptions belonging to a
        ...
        return deserialized
    list_for_billing_period_by_management_group.metadata = {'url': '/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces'}
