...
class AddsServicesOperations(object):
    ...
    :ivar api_version: The version of the API to be used with the client request. Constant value: "2018-02-02".
    ...
    def list_replication_details(
            self, service_name, filter=None, with_details=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type filter: str
        :param with_details: Indicates if InboundReplicationNeighbor details
         are required or not.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of ReplicationSummary
        :rtype:
         ~azure.mgmt.adhybridhealthservice.models.ReplicationSummaryPaged[~azure.mgmt.adhybridhealthservice.models.ReplicationSummary]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_replication_details.metadata['url']
                path_format_arguments = {
                    'serviceName': self._serialize.url("service_name", service_name, 'str')
                }
                url = self._client.format_url(url, **path_format_arguments)
                ...
                if with_details is not None:
                    query_parameters['withDetails'] = self._serialize.query("with_details", with_details, 'bool')
                query_parameters['api-version'] = self._serialize.query("self.api_version", self.api_version, 'str')
        ...
        # Deserialize response
        deserialized = models.ReplicationSummaryPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.ReplicationSummaryPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list_replication_details.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/replicationdetails'}

    def list_replication_summary(
        ...
        def internal_paging(next_link=None, raw=False):
            ...
            if not next_link:
                # Construct URL
                url = self.list_replication_summary.metadata['url']
                path_format_arguments = {
                    'serviceName': self._serialize.url("service_name", service_name, 'str')
                }
                url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    list_replication_summary.metadata = {'url': '/providers/Microsoft.ADHybridHealthService/addsservices/{serviceName}/replicationsummary'}
